...
class OptimizedSARCollector5Month:
    ...
    async def collect_5month_data(self):
        ...
        for month in months:
            ...
            # Update global stats
            self.progress["collection_stats"]["total_dark_vessels"] += month_results["total_dark_vessels"]
    ...
    async def collect_region_month_data(self, month, region):
        ...
        try:
            dark_vessels = await self.collect_sar_data(
                ...
                region["id"], region["type"], filters=[{"matched": "false"}]
            )
    ...
    def print_final_summary(self):
        ...
        logger.info(f"🕳️ Total dark vessels: {self.progress['collection_stats']['total_dark_vessels']}")
